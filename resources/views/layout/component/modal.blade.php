        ...
        <div class="modal-content">
            <form action="/purchase/tambah_pesanan" method="post">
                <div class="modal-header">
                    <h4 class="modal-title">@yield('judul_modal')</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="purchase_order_id" readonly value="{{ $purchases->kode }}" id=""
                                class="form-control">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" placeholder="masukan jml diterima" type="number" name="diterima"
                                id="">
                        </div>
