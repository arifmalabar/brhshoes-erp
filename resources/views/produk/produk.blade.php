                                    ...
                                    <td>
                                        <center>
                                            <button class="btn btn-outline-info btn-sm" data-toggle="modal"
                                                data-target="#editProdukModal" data-kode="{{ $key->id }}"
                                                data-nama="{{ $key->nama_produk }}" data-hj="{{ $key->harga_jual }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Masukan Nama Produk" name="nama_produk" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="Masukan Harga Jual" name="harga_jual" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="Masukan Harga Modal" name="harga_modal" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Masukan Internal Reference" name="internal_reference"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Nama Produk</label>
                                <input type="text" placeholder="Masukan Nama Produk" name="nama_produk" id="nama_produk"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Harga Jual</label>
                                <input type="number" placeholder="Masukan Harga Jual" name="harga_jual" id="harga_jual"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Harga Modal</label>
                                <input type="number" placeholder="Masukan Harga Modal" name="harga_modal"
                                    id="harga_modal" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Internal Reference</label>
                                <input type="text" placeholder="Masukan Internal Reference" name="internal_reference"
                                    id="internal_reference" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
